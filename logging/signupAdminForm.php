...
<div class="container">
    <form action="signupAdmin_db.php" method="POST">
        ...
        <?php } ?>
            <h1 class="h3 text-center mb-3">ແບບຟອມເພີ່ມຜູ້ດູແລລະບົບ</h1>
            ...
            <div class="form-group">
                <button class="btn btn-primary w-100 py-2 mb-2 ms-auto" type="submit" name="submit">ເພີ່ມຜູ້ດູແລລະບົບ</button>
            </div>
        </form>
    </div>
</main>
